...
const REVEAL_CONTENT = [
  {
    upper: ["Nombre: Diego Fernando Revollo Garcia", "Edad:21"],
    lower: "Ocupacion: Estudiante de la Carrera de Ingenieria en Sistemas",
  },
  {
    upper: [
      "Entre mis principales fascinaciones esta la lectura, ver series/anime y los videojuegos.",
      "- Libro favorito: Yumi y el Pintor de Pesadillas.",
      "- Serie favorita: Breaking Bad.",
      "- Videojugo favorito: Persona 5 Royal.",
    ],
    lower: [
      "En cuanto a deportes me gusta el ciclismo y muy pronto aprendere a nadar... Espero...",
    ] 
  },
  {
    upper: [
      "Un par de datos curiosos sobre mi son:",
      "Mis gustos musicales son muy variados, demasiado...",
      "Primero empece escuchando Rock alternativo a menos de Linkin Park y ahora le añadi musica de anime y sountracks.",
    ],
    lower: "Igualmente mantengo una racha de Duolingo de mas de 1100 dias.",
  },
];
